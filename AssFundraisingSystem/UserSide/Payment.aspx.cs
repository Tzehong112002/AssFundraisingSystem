...
namespace AssFundraisingSystem.UserSide
{
    public partial class Payment : System.Web.UI.Page
    {
        ...
        protected void Pay_Click(object sender, EventArgs e)
        {
            ...
            string sql = "INSERT INTO Payment(PaymentID, Name, Email, IC, ContactNumber, Amount, PaymentStatus, UserID, EventID) VALUES (@PaymentID, @Name, @Email, @Ic, @Contact, @Amount, @PaymentStatus, @UserID, @EventID)";
